...
const Navbar = () => {
  const nav=[
  { liClass:"nav-item px-2 fw-semibold", aClass:"nav-link", href:"/", name:"Home" },
  { liClass:"nav-item px-2 fw-semibold", aClass:"nav-link", href:"#", name:"About"},
  { liClass:"nav-item px-2 fw-semibold", aClass:"nav-link", href:"#", name:"Services"},
  { liClass:"nav-item px-2 fw-semibold", aClass:"nav-link",href:"#",name:"Department"},
