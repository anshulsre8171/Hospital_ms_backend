     ...
     <div className="row login-row px-5 my-bg-color1">
        ...
        {userType==="patient" && (
          ...
          <div className='mb-4'>
            ...
            <div className='row'>
              <div className='col-6 border border-1 rounded-4 text-bg-light my-4 p-2 text-center mx-auto btn my-btn-hover1'>sign in with Google</div>
            </div>
        ...
        <div>If you have already register? <Link href="./login">Click here</Link></div>
            </form>
        </div>
      </div>     
